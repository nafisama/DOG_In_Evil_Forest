...
class Board {
	...
	int startx=0;  //Where the dog enters the board (randomly along the left side)
	int starty=0;  //again, the dog's y entrance to the board (0)
	int endx=0;  // THe goal location on the right side (random x value)
	int endy=0;  // will be size -1
